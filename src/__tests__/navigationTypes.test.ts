import { isNavigationLeg, legForOrderStatus, validateOtp, validatePingCoords } from '@/features/navigation/types';
import { buildOsMapsUrl } from '@/features/navigation/osMapsUrl';
import { LOCATION_PING_INTERVAL_MS, LocationPingBuffer } from '@/features/navigation/pingBuffer';
