...
import { createStompClient, type FoodieStompClient } from '@/websocket/stompClient';
import { type WebSocketMessage } from '@/types/websocket';
import { ENV } from '@/constants/env';
import { selectAccessToken, type AuthState } from '@/features/auth/authSlice';

/**
 * WebSocket middleware — Blueprint §34.2 / P2-DEL-02 (XAP-01 embedded).
 * Handlers stay outside Redux (non-serializable); actions carry destinations only.
 * GAP-IA-11: Delivery order-topic auth wording residual — Partial until confirmed.
 */
