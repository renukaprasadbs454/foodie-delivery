    ...
    <div style={{ padding: 24, maxWidth: 1400, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #E5E7EB', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ fontSize: 24, fontWeight: 900, color: '#0F3D21', marginTop: 4 }}>₹4,82,500.00</div>
          <div style={{ fontSize: 11, color: '#15803D', marginTop: 4 }}>+14.2% vs yesterday</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #E5E7EB', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#6B7280', textTransform: 'uppercase' }}>PENDING PAYOUTS</div>
          <div style={{ fontSize: 24, fontWeight: 900, color: '#D97706', marginTop: 4 }}>18 Batches</div>
          <div style={{ fontSize: 11, color: '#D97706', marginTop: 4 }}>Razorpay Auto-Payout</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #E5E7EB', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#6B7280', textTransform: 'uppercase' }}>HIGH-RISK APPROVALS</div>
          <div style={{ fontSize: 24, fontWeight: 900, color: '#B91C1C', marginTop: 4 }}>3 Requests</div>
          <div style={{ fontSize: 11, color: '#B91C1C', marginTop: 4 }}>Requires Dual Sign-Off</div>
        </div>

        <div style={{ backgroundColor: '#FFFFFF', padding: 20, borderRadius: 12, border: '1px solid #E5E7EB', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#6B7280', textTransform: 'uppercase' }}>RECONCILIATION SLA</div>
          <div style={{ fontSize: 24, fontWeight: 900, color: '#15803D', marginTop: 4 }}>99.6%</div>
          <div style={{ fontSize: 11, color: '#15803D', marginTop: 4 }}>T+1 Settlement SLA</div>
        </div>
      </div>
